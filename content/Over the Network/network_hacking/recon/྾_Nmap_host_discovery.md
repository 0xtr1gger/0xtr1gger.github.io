...
There's a way to infer the operating system of the target host even without running Nmap OS detection scripts (`-O` option), **just based TTL values in response IP packets**.
